...
import paying from "../../Imgs/pay.png";
    ...
    <div className="footer">
      <div className="footerin1">
        <div className="f1">
          ...
          <p>
            GroceryEase is a leading online grocery store in the India. We are
      ...
      <div className="footerin2">
        <h3> &#169; Copyright Prince Kumar Singh, Inc. All rights reserved </h3>
        <img src={paying} alt="Payment" />
      </div>
    </div>
  );
};
